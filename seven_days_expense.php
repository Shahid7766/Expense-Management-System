...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h1 class="text-center mt-5 mb-5">Seven Day's Expenses</h1>
        </div>
        <div class="col-12">
...
<div class="container ">
    ...
    <tbody>
        <?php 
            ...
            echo $today_date . " - " . $previous_seven_days_date;
            $fetch_expense = "SELECT * FROM expense_info WHERE expenseDate BETWEEN '$previous_seven_days_date' AND '$today_date' ORDER BY expenseDate DESC";
